...
\\end{bmatrix}`}
        ...
        <section className="space-y-4">
          ...
          <p>First off, we need to create a Rust struct called <code>Vec3</code> to represent a 3D vector.</p>


          <ul className="list-disc pl-6 space-y-2">
            <li>
              It should contain <code className="px-1 py-0.5 rounded bg-base/60">(x, y, z)</code>{" "}
              variables
            </li>
            <li>
              You should{" "}
            ...
            <li>
              ...
              <span className="font-semibold">unit</span> vectors for the x, y and z
              directions.
            </li>
          </ul>
          <Dropdown>  <pre
...
`}</code>
        ...
        {/* Task 1 */}
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold">Task 2: 3D Vector Arithmetic</h2>
          <Dropdown>  <pre
            className="overflow-x-auto rounded-2xl border border-primary/20 bg-base/40 p-4 text-sm">
            <code>{``}</code>
          </pre>
